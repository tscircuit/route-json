import type { Rect, Line, Circle, Point } from "graphics-debug"
import type { SimpleRouteJson } from "spec/simple_route_json"
import { getColorMap, safeTransparentize } from "lib/utils/getColorMap"
import { mapZToLayerName } from "lib/utils/mapZToLayerName"
import { mapLayerNameToZ } from "lib/utils/mapLayerNameToZ"

export const convertRouteJsonToGraphicsObject = (srj: SimpleRouteJson) => {
  const lines: Line[] = []
